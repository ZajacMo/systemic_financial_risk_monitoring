    ...
    <div class="home-main">
      <div class="body-container">
        <div class="display-row">
          <div class="display-col" style="width: 68%">
            <div class="display-row">
            ...
            <div class="display-row">
              <div class="display-col" style="width: 32%">
                ...
                <riskMap
                  class="card"
                  style="height: 400px; max-width: 100%; padding: 0px"
                ></riskMap>
          ...
          <div class="display-col" style="width: 30%">
            <i class="el-icon-chat-line-round icon">&ensp;|&ensp;AI 助手</i>
